...
import { _ as _objectWithoutProperties, f as formatMoney, P as Page, T as TopBar, e as envelopes, a as actions } from './Page.6c023e9d.js';
import { P as PlusIcon } from './PlusIcon.5f5ccc3d.js';
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div1, file, 19, 4, 403);
      attr_dev(div2, "class", "font-mono text-base");
      add_location(div2, file, 22, 4, 454);
      attr_dev(div3, "class", "text-dark flex flex-col");
...
function create_default_slot_1(ctx) {
  ...
  return block;
} // (40:4) {#each $envelopes as envelope (envelope._id)}
...
function create_each_block(key_1, ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(40:4) {#each $envelopes as envelope (envelope._id)}",
    ctx: ctx
  });
  return block;
} // (22:0) <Page>

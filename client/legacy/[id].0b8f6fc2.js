import { F as _inherits, G as _getPrototypeOf, H as _possibleConstructorReturn, J as _classCallCheck, K as init, L as safe_not_equal, M as _assertThisInitialized, N as dispatch_dev, O as _createClass, P as SvelteComponentDev, Q as validate_slots, ac as _slicedToArray, aC as globals, a7 as validate_each_argument, R as element, V as space, W as claim_element, X as children, Z as detach_dev, $ as claim_space, a0 as attr_dev, a1 as add_location, a2 as insert_dev, a3 as append_dev, aj as action_destroyer, a4 as listen_dev, aD as destroy_each, ao as run_all, aE as empty, aF as HtmlTag, aG as toggle_class, U as text, Y as claim_text, aH as set_data_dev, a5 as noop, ay as regenerator, a9 as create_component, aa as claim_component, ab as mount_component, ad as transition_in, ae as transition_out, af as destroy_component, ag as validate_store, ah as component_subscribe, ai as goto, aI as binding_callbacks, aJ as bind, aK as add_flush_callback } from './client.2be03181.js';
import { P as Page, _ as _asyncToGenerator, T as TopBar, e as envelopes, a as actions, R as ROUTES, b as _defineProperty } from './constants.49c06a24.js';
...
function create_default_slot_3(ctx) {
  ...
  return block;
} // (61:6) <Button         on:click="{() => {           if (id !== 'new') {             goto(`${ROUTES.ENVELOPE}/${id}`);             return;           }           goto(ROUTES.HOME);         }}"       >
...
function create_default_slot_2(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(61:6) <Button         on:click=\\\"{() => {           if (id !== 'new') {             goto(`${ROUTES.ENVELOPE}/${id}`);             return;           }           goto(ROUTES.HOME);         }}\\\"       >",
    ctx: ctx
  });
  return block;
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  var click_handler_1 = function click_handler_1() {
    if (id !== "new") {
      goto("".concat(ROUTES.ENVELOPE, "/").concat(id));
      return;
    }
